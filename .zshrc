...
# source ~/.local/bin/start-tmux.sh
...
PATH="/home/wheat/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/home/wheat/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/home/wheat/perl5${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}"; export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/home/wheat/perl5\""; export PERL_MB_OPT;
